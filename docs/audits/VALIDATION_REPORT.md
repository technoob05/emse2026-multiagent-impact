...
- Manuscript: 32 A4 pages. Supplementary Information: 32 A4 pages. Both counts are read from the built PDFs on the date of this report; re-measure rather than trusting them after any edit.
