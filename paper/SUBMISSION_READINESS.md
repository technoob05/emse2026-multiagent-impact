...
- [x] 4 appendix figures explain dataset layers, joins, and feature-specific denominators.
...
- [x] Page-complete visual QA covers all 35 manuscript pages and all 34 Supplementary Information pages, which carry 13 tables.
