...
$sourceFiles = @(
    ...
    "sn-basic.bst",
    "fig1_diagram.tex",
    "fig1-robot-purple-code.png",
    "fig1-code-window.png",
    "fig1-robot-blue-chat.png",
    "fig1-speech-bubble.png",
    "fig1-person-green.png",
    "fig1-reply-card.png",
    "fig1-git-branch-orange.png",
    "fig1-tick-green.png",
    "fig1-calendar-48h.png",
    "fig1-arrow-gradient-rainbow.png",
    "Fig2.pdf",
    "Fig3.pdf",
    "Fig4.pdf",
    "Fig5.pdf",
